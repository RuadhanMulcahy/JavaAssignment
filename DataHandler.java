...
public class DataHandler {
	...
	public String mainDriver(String val1, String val2, String val3, String val4, String val5, String val6, String val7, String val8, String val9) {	
		...
		try {
			...
			ResultSet stat1 = myStmt.executeQuery("select count(" + val1 + ") from FIRESTAT where " + val1 +  " = '" + val2 + "' and " + val3 + " between '" + val4 + "-" + month1 + "-" + val6 + "' and '" + val7 + "-" + month2 + "-" + val9 + "'");
